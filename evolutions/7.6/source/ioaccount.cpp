...
bool IOAccount::accountExists(unsigned long accno)
{
    return false;
}

bool IOAccount::saveAccount(Account account, unsigned long premiumTicks)
{
    return false;
}

#ifdef __XID_ACCOUNT_MANAGER__
bool IOAccount::createAccount(Account account)
{
    return false;
}
#endif
