...
bool ItemType::isWater() const
{
	return (id >= 490 && id <= 492) || (id >= 618 && id <= 629) ||
           (id >= 4608 && id <= 4625) || (id >= 4664 && id <= 4666) || (id >= 4820 && id <= 4825);
}

bool ItemType::isLava() const
{
	return (id >= 598 && id <= 601) || id == 1509;
}

bool ItemType::isSwamp() const
{
	return (id >= 602 && id <= 605) || (id >= 4691 && id <= 4712) ||
           (id >= 4749 && id <= 4755) || id == 4758;
}

bool ItemType::isTar() const
{
	return id >= 708 && id <= 711;
}
					...
					while(itemAttributesNode){
						if(readXMLString(itemAttributesNode, "key", strValue)){
							if(strcasecmp(strValue.c_str(), "type") == 0){
								...
								if(readXMLInteger(itemAttributesNode, "value", intValue)){
									it.increasePhysicalPercent = intValue;
								}
							}
							#ifdef __XID_PREVENT_LOSS__
