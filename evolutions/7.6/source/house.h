...
public:
	...
	void setHouseOwner(std::string name);
	std::string getHouseOwner() const {return houseOwner;};
...
public:
	...
	House* getHouseByPlayerName(std::string playerName);

	bool loadHousesXML(std::string filename);
	
	bool payHouses(bool letter);
